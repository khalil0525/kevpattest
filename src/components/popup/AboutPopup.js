...
import AboutPopupAnimatedThink from "../AnimatedText/AnimatedTextThinking";
          ...
          <div className="left_inner">
            <div className="author">
              <div className="avatar_image">
                <Image src="/img/thumbs/1-1.jpg" alt="" layout="fill" />
                <div className="main" data-img-url="img/about/Logo.png" />
              </div>
              <div className="short">
              ...
              <ul>
                ...
                <li>
                  <div className="list_inner">
                    ...
                    <span>
                      <a
                        href="https://goo.gl/maps/1aDUjgXygfAj1Eug6"
                ...
                <li>
                  <div className="list_inner">
                    ...
                    <span>
                      <a href={`mailto:hey@hermtac.com?subject=Hey There!`}>
                        hey@hermtac.com
                      </a>
                    </span>
                  </div>
